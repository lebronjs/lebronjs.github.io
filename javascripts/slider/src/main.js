/*
* @Author: tangxu
* @Date:   2016-04-02 15:26:54
* @Last Modified by:   tangxu
* @Last Modified time: 2016-04-02 17:14:45
*/
...
(function($){
    $.fn.slider=function(options){
        ...
        var defaults = {
                        ...
                        autoPlay:    true,///是否自动自动轮播,默认否，若要自动轮播请设置成true
                        scrollWhere: "next"//自动滚动方向，默然是上，下的参数为 next
                    };
        ...
        var slider = {
                scrollLNext: function (){
                    if(!gb.cont.is(":animated")){
                        gb.cont.children().slice(0,gb.n).clone(true).appendTo(gb.cont);
